...
<header class="fixed top-0 w-full bg-white border-b border-gray-200 grid grid-rows-[25%_75%] h-[5.5rem] sm:h-[6.5rem] md:h-[7rem] font-sans text-[11px] sm:text-[12px] md:text-[13px] z-[100] transition-all duration-300">
    ...
    <div class="grid grid-cols-[38%_24%_38%] sm:grid-cols-[40%_20%_40%] px-2 sm:px-4 md:px-6 items-center">
        ...
        <div class="{Full} flex items-center gap-1.5 sm:gap-3 md:gap-5 font-medium tracking-wide text-gray-800  scrollbar-none">
            ...
            <button 
                onclick={() => goto("/inbox")} 
                class="relative p-1 sm:p-1.5 text-gray-600 hover:text-slate-900 rounded-full hover:bg-gray-100 transition-colors duration-200 cursor-pointer shrink-0"
                aria-label="Inbox"
            >
            ...
            <div class="group relative p-1 sm:p-1.5 text-gray-600 hover:text-slate-900 rounded-full hover:bg-gray-100 transition-colors duration-200 cursor-pointer shrink-0">
                <span class="absolute -top-1 -right-1 flex h-3.5 w-3.5 sm:h-4 sm:w-4 items-center justify-center rounded-full bg-slate-900 text-[9px] sm:text-[10px] font-bold text-white px-1">3</span>
                <svg class="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="{Full} flex items-center justify-center">
            <img class="h-12 sm:h-16 md:h-20 mt-1 object-contain transition-all duration-300" src="/src/constant/LogoBurung.png" alt="Logo Burung">
        </div>
        ...
        <div class="{Full} flex items-center justify-end gap-2 sm:gap-4 md:gap-6 text-gray-700 {FontSection}">
            ...
            <!-- Form Pencarian -->
            <div class="relative border-b border-transparent hover:border-black focus-within:border-black pb-0.5 sm:pb-1 transition-colors duration-300">
                <form 
                    onsubmit={(e) => {
                        e.preventDefault();
                ...
                >
                    <input 
                        ...
                        class="bg-transparent outline-none text-[11px] sm:text-[12px] transition-all duration-500 ease-in-out placeholder-gray-400 {navbarState.searching ? 'w-28 sm:w-44 md:w-64' : 'w-16 sm:w-24 md:w-32'}"
                    />
                </form>
            ...
            <div class="flex items-center gap-1 sm:gap-2 md:gap-4 transition-all duration-500 ease-in-out {navbarState.searching ? 'w-0 opacity-0 pointer-events-none overflow-hidden' : 'w-auto opacity-100'}">
                
                <!-- Account / Sign menu -->
                <div class="group relative shrink-0">
                    <div class="cursor-pointer p-1 sm:p-2 text-gray-600 hover:text-slate-900 rounded-full hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center" title="Account">
                    ...
                    <div class="absolute right-0 top-full mt-2 w-44 sm:w-48 bg-white border border-gray-100 rounded-lg shadow-xl py-1 invisible opacity-0 group-hover:visible group-hover:opacity-100 transition-all duration-200 z-50">
                        <a href="/home" class="block px-4 py-2 text-xs text-gray-700 hover:bg-gray-50 hover:text-slate-900">Home</a>
                ...
                <!-- Transaksi -->
                <a href="/transaksi" class="p-1 sm:p-2 text-gray-600 hover:text-slate-900 rounded-full hover:bg-gray-100 transition-colors duration-200 shrink-0" title="Transaksi">
                    <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <!-- Wishlist & Likes -->
                <div class="group relative shrink-0">
                    <div class="cursor-pointer p-1 sm:p-2 text-gray-600 hover:text-slate-900 rounded-full hover:bg-gray-100 transition-colors duration-200 flex items-center justify-center" title="Wishlist & Likes">
                        <svg class="w-5 h-5 sm:w-[22px] sm:h-[22px]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
