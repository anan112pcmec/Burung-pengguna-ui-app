<script lang="ts">
	import CartHeader from "$lib/page/main/cart/CartHeader.svelte";
...
<main class="mt-[7rem] grid grid-cols-[72%_28%] pl-2 pr-2">
    {#if CartPageState.IsHapusKeranjang()}
        <HapusKeranjangElement/>
    {/if}
   <div>
   <CartHeader/>
   <ListCart/>
